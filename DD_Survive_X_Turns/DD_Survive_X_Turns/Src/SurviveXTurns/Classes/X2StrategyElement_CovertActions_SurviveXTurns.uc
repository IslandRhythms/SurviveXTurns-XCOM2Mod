class X2StrategyElement_CovertActions_SurviveXTurns extends X2StrategyElement_DefaultCovertActions config(GameData);
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	CovertActions.AddItem(CreateSurviveXTurnsMissionTemplate());
...
// Survive X Turns
//---------------------------------------------------------------------------------------
static function X2DataTemplate CreateSurviveXTurnsMissionTemplate()
{
	local X2CovertActionTemplate Template;
	local int i;

	`CREATE_X2TEMPLATE(class'X2CovertActionTemplate', Template, 'CovertAction_SurviveXTurns');
	...
	Template.Narratives.AddItem('CovertActionNarrative_SurviveXTurns_Skirmishers');
	Template.Narratives.AddItem('CovertActionNarrative_SurviveXTurns_Reapers');
	Template.Narratives.AddItem('CovertActionNarrative_SurviveXTurns_Templars');
	...
	Template.Rewards.AddItem('Reward_Mission_SurviveXTurns');
